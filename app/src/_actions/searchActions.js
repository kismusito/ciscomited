...
function searchAppretice(appreticeID) {
    return dispatch => {
        ...
        searchService.searchAppretice(appreticeID)
            .then(response => {
                if (response.status) {
                    dispatch(success(response))
                } else {
    ...
    function request() { return { type: searchConstants.SEARCHONEAPRETICE_REQUEST } }
    function success(response) { return { type: searchConstants.SEARCHONEAPRETICE_SUCCESS , response } }
    function failure(response) { return { type: searchConstants.SEARCHONEAPRETICE_FAILURE , response } }
}
...
function hideModalSearched() {
    ...
    function hide() { return { type: searchConstants.HIDESEARCHEDMODAL} }
}