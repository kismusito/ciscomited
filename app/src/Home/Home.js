                ...
                <div className="custom_background_sidebar">
                    <div className="custom_background_apps">
                        <ul className="apps_items_list">
                            {getRolInfoReducer.status && getRolInfoReducer.rolInfo.isAdmin && (
                            ...
                            {getRolInfoReducer.status && getRolInfoReducer.rolInfo.isAdmin && (
                                <li className="list_item_apps">
                                    <Link className="list_item_apps_link" to="/editUsers">
                                        ...
                                        <div className="subtitle">
                                            Esta herramienta te permite buscar usuarios y editar sus
                                            atributos.
                                        </div>
                                    </Link>
                                </li>
                            ...
                            {getRolInfoReducer.status && getRolInfoReducer.rolInfo.isAdmin && (
                                <li className="list_item_apps">
                                    <Link className="list_item_apps_link" to="/uploadApprentices">
                                        ...
                                        <div className="subtitle">
                                            Con esta herramienta podrás subir masivamente todos los
                                            aprendices desde un archivo XML.
                                        </div>
                                    </Link>
                                </li>
                            )}
                            ...
                            {getRolInfoReducer.status && getRolInfoReducer.rolInfo.isAdmin && (
                                <li className="list_item_apps">
                                    <Link className="list_item_apps_link" to="/roles">
                                        ...
                                        <div className="subtitle">
                                            Con esta herramienta podrás subir masivamente todos los
                                            instructores desde un archivo XML.
                                        </div>
                                    </Link>
                                </li>
                            )}
                            ...
                            {getRolInfoReducer.status && getRolInfoReducer.rolInfo.isAdmin && (
                                <li className="list_item_apps">
                                    <Link className="list_item_apps_link" to="/searchAppretices">
                                        <div>
                                            <img
                                                src="/assets/img/search_user.png"
                                                alt="edit roles"
                                            />
                                        </div>
                            ...
                            <li className="list_item_apps">
                                <Link className="list_item_apps_link" to="/myCitations">
                                    <div>
                                        <img src="/assets/img/icon_add_file.png" alt="edit roles" />
                                    </div>
                            ...
                            <li className="list_item_apps">
                                <Link className="list_item_apps_link" to="/citations">
                                    ...
                                    <div className="subtitle">
                                        Construye dinámicamente una citación, con esta herramienta
                                        podrás construir citaciones en cuestión de segundos.
                                    </div>
                                </Link>
                            </li>
                            ...
                            <li className="list_item_apps">
                                <Link className="list_item_apps_link" to="/generateMinutes">
                                    ...
                                    <div className="subtitle">
                                        Construye dinámicamente tus actas, con esta herramienta
                                        podrás construir actas en cuestión de segundos.
                                    </div>
                                </Link>
                            </li>
                        </ul>
