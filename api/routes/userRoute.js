...
const { register , getRoleInfo , searchUsers , searchUser , editUserSearch , getCitations , getSelectedCitation , uploadNewCitationStatus} = require('../controllers/userController')
...
router.post('/uploadNewCitationStatus' , verifyMiddleware , upload.single("newFileToUpload") , uploadNewCitationStatus)
