                ...
                <div className="custom_background_sidebar">
                    <div className="center_container">
                        <div className="container_white_edit no_over_hidden">
                            ...
                            <div className="subtitle mb-4">Para generar una citacion necesitaremos varios datos, puedes utilizar el buscador avanzado de aprendizes, solo busca el aprendiz y dale clic.</div>
                            ...
                            <form autoComplete="off" onSubmit={this.eHandleSubmitGenerate}>
                                ...
                                <div className="appretices_selected_container">
                                    {this.state.appreticesSelected.map(appretices => (
                                        <div className="container_selected_appretice" key={appretices.appreticeID}>
                                            <div className="text_appretice_selected">{appretices.name + " " + appretices.lastName}</div>
                                            <div className="icon_delete_selected" onClick={() => this.deleteSelectedAppretice(appretices.appreticeID)}><HighlightOff /></div>
                                        </div>
                                    ))}
                                </div>
                                    ...
                                    <div className="search_container">
                                        <ul className="search_list">
                                            {searchReducer.appretices.map(appretice => (
                                                <li className="search_list_item" key={appretice._id} onClick={() => this.showAppreticeSelect(appretice._id, appretice.nombre, appretice.primer_apellido)}>
                                ...
                                <div className="form_group_search">
                                    <div className="title_search leftMargin mb-2">Instructor líder</div>
                                    <input
                                        type="text"
                                ...
                                <div className="form_group_search">
                                    <div className="title_search leftMargin mb-2">Link de la reunión</div>
                                    <input
                                        type="text"
                                        name="meetingLink"
                                ...
                                <div className="form_group_search">
                                    ...
                                    <div className="subtitle leftMargin mb-2">Esto te ayudara a reconocer la citación mas facilmente.</div>
                                    <input
                                        type="text"
                                ...
                                <div className="form_group_search">
                                    <button className="btn btn_big btn_orange">Generar citación</button>
                                </div>
                            </form>
                            ...
                            {generateConstantReducer.status &&
                                <div className="modal_overlay_role">
                                    <div className="citations_ove">
                                        <div className="text_citation">La citación se ha generado correctamente, podras verla en el apartado de citaciones</div>
                                        <button className="btn btn_orange btn_link" onClick={this.eHandleCitationViews}>Ver citaciones</button>
                                    </div>
                                </div>
                            }
                            ...
                            {generateConstantReducer.loading &&
                                <div className="loading_file change_loader_color">
                                    <div className="text_loading">Estamos generando la citación. Esto puede tardar unos segundos.</div>
...
const searchAppreticesToCitationComponent = connect(mapStateToProps, actionCreator)(SearchAppreticesToCitation)
