    ...
    validateCredentials = credentials => {
        if (credentials.usernameoremail.length > 0) {
            if (credentials.password.length >= 3) {
                let validateIfIsEmail = credentials.usernameoremail.match(/^([\w.%+-]+)@([\w-]+\.)+([\w]{2,})$/i)
                ...
                <div className="container_login">
                    <div className="form_desing_part">
                        ...
                        <form method="POST" onSubmit={this.eHandleFormSubmit}>
                            <div className="form_group">
                                ...
                                {this.state.formError.show && this.state.formError.type === "userOrEmailError" &&
                                    <div className="alert_error_login">{this.state.formError.message}</div>
                                }
                            </div>
                            ...
                            <div className="form_group">
                                ...
                                {this.state.formError.show && this.state.formError.type === "passwordError" &&
                                    <div className="alert_error_login">{this.state.formError.message}</div>
                                }
                            ...
                            <div className="links_section_form">
                                <a href="https://deprueba.com" className="forgot_password_link">Olvidaste tu contraseña?</a>
                    ...
                    <div className="custom_desing_circles">
                        <div className="custom_desing_circles_left">
                            <div className={authReducer.validating ? "circle_side circle1_desing loading_circle" : "circle_side circle1_desing"} >
                            </div>
