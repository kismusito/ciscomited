            ...
            <Router history={history}>
                ...
                {authReducer.auth && uploadReducer.status &&
                    <div className="show_alert_popUp alert_show">
                        ...
                        <button className="btn mt-5 btn_teal" onClick={this.eHandleHideAlert}>Entendido</button>
                    </div>
                }
                ...
                <Switch>
                    ...
                    <PrivateRoute path="/editProfile" component={EditProfile} auth={authReducer.auth} />
