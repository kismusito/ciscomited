                        ...
                        <div className="container_white_edit min_height center_elements">
                            ...
                            {uploadReducer.loading &&
                                <div className="loading_file">
                                    <div className="text_loading">Estamos procesando el archivo.</div>
                                    <div className="loader_upload"></div>
                                </div>
                            }


                            <form method="POST" encType="multipart/form-data" onSubmit={this.eHandleSubmitForm} className="form_total_size center_elements" ref={input => this.formData = input}>

                                <input type="file" name="fileUpload" id="fileUpload" onChange={this.submitForm} className="file_input_container" required={true} />
