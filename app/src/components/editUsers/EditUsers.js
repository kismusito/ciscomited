                                ...
                                <div className="search_container">
                                    <ul className="search_list">
                                        {searchUsersReducer.users.map(user => (
                                            <li className="search_list_item" key={user._id} onClick={() => this.editUserSelected(user._id)}>
                                                <div className="two_colums_search">
                                                    <div className="picture_column">
                                                        <img src={user.profilePicture ? user.profilePicture : "/assets/img/usuario.png"} className="profile_picture" alt="profile_picture" />
                                                    </div>
                                                    <div className="search_info_user">
                                                        <div className="title_search">{user.email}</div>
                            ...
                            {this.state.showModalEditUser && searchedUserReducer.status &&
                                <div className="modal_overlay_role min_height">
                                    ...
                                    <div className="form_desing_edit">
                                        ...
                                        <div className="subtitle">Bienvenido al editor de usuario, recuerda que por motivos de seguridad no puedes cambiar la contraseña ni la foto de perfil.</div>
                                        ...
                                        <form method="POST" onSubmit={this.eHandleTriggerEditUser}>
                                                ...
                                                <div className="rows">
                                                    <div className="col_6">
                                                        <input
                                                            ...
                                                            defaultValue={searchedUserReducer.userInfo.first_name} />
                                                    </div>
                                                    <div className="col_6">
                                                        <input
                                                            type="text"
                                                            ...
                                                            defaultValue={searchedUserReducer.userInfo.last_name} />
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div className="rows">
                                                    <div className="col_6">
                                                        <input
                                                            ...
                                                            defaultValue={searchedUserReducer.userInfo.username} />
                                                    ...
                                                    <div className="col_6">
                                                        <input
                                                            ...
                                                            defaultValue={searchedUserReducer.userInfo.email} />
                                            ...
                                            <div className="links_section_form">
                                                <button className="btn btn_big btn_orange">Editar usuario</button>
                                            </div>

                                            {!editUserSearchReducer.status && 
                                                <div className="alert_error_edit mt-2">{editUserSearchReducer.message}</div>
                                            }

                                            {editUserSearchReducer.status && 
                                                <div className="alert_success_edit">{editUserSearchReducer.message}</div>
                                            }
                                        </form>
                                    </div>
                                </div>
