                                ...
                                <div className="modal_overlay_role height_auto">
                                    ...
                                    <div className="form_desing_edit">
                                        ...
                                        <div className="form_group_info">
                                            ...
                                            <div>{apreticeSearchedReducer.appretice.nombre + " " + apreticeSearchedReducer.appretice.primer_apellido + " " + apreticeSearchedReducer.appretice.segundo_apellido}</div>
                                        </div>

                                        <div className="form_group_info">
                                            <div className="subtitle">Documento</div>
                                            <div>{apreticeSearchedReducer.appretice.tipo_documento + " - " + apreticeSearchedReducer.appretice.numero_documento}</div>
                                        </div>

                                        <div className="form_group_info">
                                            <div className="subtitle">Estado del aprendiz</div>
                                            <div>{apreticeSearchedReducer.appretice.estado_aprendiz}</div>
                                        </div>

                                        <div className="title_search">Programas de formación</div>

                                        {apreticeSearchedReducer.appretice.programas_formacion.map(program => (
                                            <div key={program.codigo_programa}>
                                                <div className="form_group_info">
                                                    <div>Programa: <span className="subtitle">{program.programa}</span></div>
                                                    <div>Nivel de formación: <span className="subtitle">{program.nivel_de_formacion}</span></div>
                                                    <div>Sede: <span className="subtitle">{program.sede}</span></div>
                                                    <div>ficha: <span className="subtitle">{program.ficha}</span></div>
                                                </div>
                                            </div>
                                        ))}
